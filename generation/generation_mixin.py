...
class InferenceParams:
    ...
    def __new__(cls, *args, **kwargs):
        """
        Singleton pattern to ensure that only one instance of InferenceParams.
        This is to avoid FSDP issues.
        """
    ...
    **kwargs,
    ...
    def get_logits(input_ids, inference_params):
        ...
        if decoding:
            ...
            # position_ids = None  # Remove explicit position_ids to avoid the flash attention bug
        else:
            position_ids = None
    ...
    def should_stop(current_token, inference_params):
        ...
        if stopping_criteria is not None:
            return any(stopping_criteria(current_token, inference_params))
        return False
