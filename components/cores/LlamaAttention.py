...
from transformers.models.llama.modeling_llama import LlamaAttention, LlamaConfig, LlamaRotaryEmbedding, DynamicCache
...
class Mixer(nn.Module):
    def __init__(
        ...
        self.self_attn = LlamaAttention(config=config, layer_idx=layer_idx).to(dtype)
